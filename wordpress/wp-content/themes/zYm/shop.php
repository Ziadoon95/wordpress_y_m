      ...
      <main class="main-content">
        <div class="fullwidth-block download">
          <div class="container">
            <div class="row">
              <div class="col-md-5">
                <h2 class="page-title">Buy the Music</h2>

                <div class="item">
                  <h3 class="item-title">Chia cornhole</h3>
                  <span class="year">2014</span>
                  <a href="#" class="button small primary">Buy</a>
                ...
                <div class="item">
                  <h3 class="item-title">Thundercats</h3>
                  <span class="year">2014</span>
                  <a href="#" class="button small primary">Buy</a>
                  <a href="#" class="button small secondary">Listen to</a>
                  <div class="social-share">
                ...
                <div class="item">
                  <h3 class="item-title">Plaid palo</h3>
                  <span class="year">2014</span>
                  <a href="#" class="button small primary">Buy</a>
                  <a href="#" class="button small secondary">Listen to</a>
                  <div class="social-share">
              ...
              <div class="col-md-5 col-md-push-2">
                ...
                <div class="item">
                  ...
                  <span class="year">2014</span>
                  <a href="#" class="button small primary">Buy</a>
                  <a href="#" class="button small secondary">Have a look</a>
                  <div class="social-share">
                    <span>Share:</span>
                    <a href="#"><i class="fa fa-facebook"></i></a>
                    <a href="#"><i class="fa fa-twitter"></i></a>
                ...
                <div class="item">
                  <h3 class="item-title">Stickers</h3>
                  <span class="year">2014</span>
                  <a href="#" class="button small primary">Buy</a>
                  <a href="#" class="button small secondary">Have a look</a>
                  <div class="social-share">
                ...
                <div class="item">
                  <h3 class="item-title">The mystery gift</h3>
                  <span class="year">2014</span>
                  <a href="#" class="button small primary">Buy</a>
                  <a href="#" class="button small secondary">Have a look</a>
                  <div class="social-share">
