...
* If you want to override this in a child theme, then include a file * called content-___.php (where _ is the Post Format name) and that will be used instead.
*/
    get_template_part(
